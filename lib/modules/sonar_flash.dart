...
class SonarFlashScreen extends StatelessWidget {
  const SonarFlashScreen({super.key});
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              gradient: RadialGradient(
                ...
                radius: 1.3,
                colors: [Color(0xFF8E2DE2), Color(0xFF4A00E0), Color(0xFF1A0040)],
              ),
            ),
          ),
          Positioned(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: const LinearGradient(
                    colors: [Color(0xFFFFEB3B), Color(0xFF8E2DE2)],
